...
--Creating a new column that calculates the win_rate in percentage
ALTER TABLE FIFA_WC
...
SELECT country,	
	...
	END AS offensive_record
FROM FIFA_WC
GROUP BY country
ORDER BY offensive_record DESC,country
...
SELECT country,	
	...
	END AS defensive_record
FROM FIFA_WC
GROUP BY country
ORDER BY defensive_record DESC,country
